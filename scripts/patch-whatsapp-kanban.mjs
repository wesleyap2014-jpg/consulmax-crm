...
if (!s.includes('Kanban de Atendimentos') && s.includes(anchor)) {
  const kanban = `      <div className="mb-4 overflow-hidden rounded-3xl border border-white/70 bg-white/80 shadow-sm backdrop-blur">
        <div className="flex flex-col gap-3 border-b border-slate-100 p-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Arraste visual por etapa: novos, triagem, comercial, proposta, boleto, contemplação e pós-venda.</p>
          </div>
