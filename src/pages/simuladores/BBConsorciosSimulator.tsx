...
export default function BBConsorciosSimulator() {
  ...
  useEffect(() => {
    if (selectedConfig.creditRanges.length && !selectedConfig.creditRanges.some((r) => r.id === creditoSelecionado)) setCreditoSelecionado(selectedConfig.creditRanges[0].id);
  ...
  }, [selectedGroup?.id, selectedConfig.creditRanges, availablePrazos, availableLances, creditoSelecionado, prazoInput, lanceKey, grupoPermiteEmbutido]);
