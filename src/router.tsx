...
// SAFE MODE flag
const SAFE_MODE = String(import.meta.env.VITE_SAFE_MODE || "0") === "1";
...
const Health                  = React.lazy(() => import("./pages/_Health"));
...
export const router = SAFE_MODE
  ? // ================== ROTEADOR EM MODO RESGATE ==================
    createBrowserRouter([
      { path: "/login", element: withSuspense(<Login />) },
      { path: "/health", element: withSuspense(<Health />) },
      // Tudo vai para /health (evita telas brancas)
      { path: "*", element: <Navigate to="/health" replace /> },
    ])
  : // ================== ROTEADOR COMPLETO (seu atual) =============
    createBrowserRouter([
      // públicas
