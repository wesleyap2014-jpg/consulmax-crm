...
if (!OPENAI_API_KEY) {
  console.warn(
    "[max-chat] Variável de ambiente OPENAI_API_KEY não definida. Configure nas settings do projeto Supabase."
  );
}
...
`;
    ...
    // Chamada à OpenAI – modelo de chat (ajuste o modelo se quiser)
